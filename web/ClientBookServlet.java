...
public class ClientBookServlet  extends BaseServlet {
    ...
    protected void page(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("page经过了前台的ClientBookServlet");
    ...
    protected void pageByPrice(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("pageByPrice经过了前台的ClientBookServlet");

        //1  获取请求的参数 pageNo和pageSize
        int pageNo = BeanUtil.parseInt(req.getParameter("pageNo"), 1);
        int pageSize = BeanUtil.parseInt("pageSize", Page.PAGE_SIZE);
        int min=BeanUtil.parseInt(req.getParameter("min"),0);
        int max=BeanUtil.parseInt(req.getParameter("max"),Integer.MAX_VALUE);
        ...
        //如果有最小价格的参数，追加到分页的参数中
        if(req.getParameter("min")!=null){
            sb.append("&min=").append(req.getParameter("min"));
        }
        //如果有最大价格的参数，追加到分页的参数中
